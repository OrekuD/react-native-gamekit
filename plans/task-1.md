...
11. **Device verification pending.** The initial iOS simulator build is running separately from this verification pass. Keep the final simulator checklist item open until the playground has launched and loaded its own Metro bundle without native or JavaScript errors.
